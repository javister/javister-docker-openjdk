...
public class JavisterOpenJDKContainer<SELF extends JavisterOpenJDKContainer<SELF>> extends JavisterBaseContainerImpl<SELF> {
     ...
     *
     * @return true, если у процесса включена отладка и false в противном случае.
     */
     ...
     *
     * <p>В JVM будут переданы соответствующие флаги, а так же из контейнера будет открыт порт для подключения
     * отладчиком.
     *
    ...
    /**
     * Включает ожидание подключения отладчика после старта JVM.
     *
